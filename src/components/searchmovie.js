              ...
              { 
               this.props.etoile.map((el, i) => 
                ...
                <p
                  ...
                  onClick={() => this.props.searchrating(i)}
                >
                  {this.props.indexet === "" ? (
                    "☆"
                  ) : (
                    <Start
                      index={i}
                      count={this.props.indexet}
                      star={this.props.etoile[i]}
                    />
                  )}
                ...
                <input className="input" placeholder='Search for movie !!!' onChange={e=>this.props.handelchange(e)}/> 
                </div>
